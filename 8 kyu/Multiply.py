...
This file is part of the SevaDactyl/Codewars-Python (https://github.com/SevaDactyl/Codewars-Python)

License is GNU General Public License v3.0 (https://github.com/SevaDactyl/Codewars-Python/blob/main/LICENSE)
